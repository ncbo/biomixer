    ...
    var Tour = (function () {
        ...
        Tour.prototype.showSubMenuIfNotVisible = function (childMenuItem, collapseOthers) {
            ...
            if (!label.hasClass(Menu.Menu.closeActionClass)) {
                ...
                // more accurately.
                label.trigger("click", function () { _this.refreshIntro(); });
            }
        };
            ...
            return [
                {
                    ...
                    onbeforechange: function () { _this.closeMenuIfVisible(); },
                    position: "bottom"
                },
                ...
                {
                    element: function () { return $(".centralNode")[0]; },
                ...
                //- search for nodes in a dense graph, via field in menu. Will trigger radar blips around each matching node
                {
                    ...
                    onbeforechange: function () { _this.showSubMenuIfNotVisible($("#nodeFinderMenuContainerScrollContainer"), true); },
                    position: "left"
                },
                ...
                {
                    element: function () { return $("rect[id^='node_expander_indicator']")[0]; },
                ...
                //- six layout algorithms available in menu (Center, Circle, Force-Directed, Vertical Tree, Horizontal Tree, and Radial layouts)
                {
                    ...
                    onbeforechange: function () { _this.showMenuIfNotVisible(); },
                    position: "bottom"
                },
                ...
                },
                {
                    ...
                    onbeforechange: function () { _this.showSubMenuIfNotVisible($("#NestedOntologyConceptFilterScrollContainer"), true); },
                    position: "left"
                },
                ...
                },
                {
                    ...
                    onbeforechange: function () { _this.showSubMenuIfNotVisible($("#NestedExpansionSetConceptFilterScrollContainer"), true); },
                    position: "left"
                },
                //- filter edge types. Concepts can have different types of relationships between them, depending on the ontology, and these may be hidden or re-colored via the menu.
                {
                    ...
                    onbeforechange: function () { _this.showSubMenuIfNotVisible($("#ConceptEdgeTypeFilterScrollContainer"), true); },
                    position: "left"
                },
                {
                    element: $("#ConceptEdgeTypeFilterOuterContainer")[0],
                ...
                //- sharing of graphs via export and import, via the menu. Export provides json code that another user may paste into the import field, and receive the nodes, their positions and any custom edge colors, that existed at the time of export. Undo/redo state is not transferred.
                {
                    ...
                    onbeforechange: function () { _this.showSubMenuIfNotVisible($("#" + GraphImporterExporter.Widget.innerContainerId), true); },
                    position: "left"
                },
                //            
...
//# sourceMappingURL=ConceptTour.js.map